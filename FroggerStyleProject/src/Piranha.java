...
public class Piranha{
	...
	public Piranha() {
		forward = getImage("/imgs/"+"Piranha Plant.png"); //load the image for Tree
	...
	public boolean collided(Mario character) {
		...
		Rectangle thisObject = new Rectangle(x + 10, y + 5, width/2 + 10, height);
	...
	public void paint(Graphics g) {
		...
		if(Frame.debugging) {
			...
			g.drawRect(x + 10, y + 5, width/2 + 10, height);
		}
	...
	private Image getImage(String path) {
		...
		try {
			URL imageURL = Piranha.class.getResource(path);
